...
function ProductList({ onHomeClick }) {
    ...
    const handleRemoveFromCart = (plantName) => {
        setAddedToCart(prev => {
            const copy = { ...prev };
            delete copy[plantName]; // allow the button to be active again
            return copy;
        });
    };
            ...
            <div className="navbar" style={styleObj}>
                ...
                <div style={styleObjUl}>
                    ...
                    <div> <a href="#" onClick={(e) => handleCartClick(e)} style={styleA}>
                        <h1 className='cart'>
                            <span className="cart_quantity_count">{totalQuantity == 0 ? '': totalQuantity}</span>
                        ...
                        {category.plants.map((plant, plantIndex) => ( // Loop through each plant in the current category
                            ...
                            <button
                                ...
                                style={{
                                    ...
                                    color: addedToCart[plant.name] ? "#666" : "white",
